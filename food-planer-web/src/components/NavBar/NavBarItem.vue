...
import UserAvatarCurrentUser from "@/components/Common/UserAvatarCurrentUser.vue";
...
const menuClick = (event: PointerEvent) => {
...
const menuClickDropdown = (event: PointerEvent, item) => {
