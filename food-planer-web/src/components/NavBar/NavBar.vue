...
import { containerMaxW } from "@/assets/styles/styles";
...
const menuClick = (event: PointerEvent, item) => {
...
<template>
  ...
  >
    <div class="flex lg:items-stretch xl:max-w-6xl xl:mx-auto" :class="containerMaxW">
