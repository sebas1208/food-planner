...
type TextColor = "contrast" | "success" | "danger" | "warning" | "info";
type Color = "white" | "whiteDark" | "lightDark" | TextColor;
...
export const getButtonColor = (
  ...
  if (isActive) {
    ...
    base.push(isOutlinedProcessed ? colors.text[(<TextColor>color)] : colors.bg[color]);
  }

  if (hasHover) {
    base.push(
      isOutlinedProcessed ? colors.outlineHover[(<TextColor>color)] : colors.bgHover[color]
    );
  }
